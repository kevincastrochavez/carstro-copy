...
function Header() {
  ...
  useEffect(() => {
    if (
      ...
      // Production
      window.location.href === 'https://carstro-copy.web.app/' ||
      window.location.href === 'https://carstro-copy.web.app/aboutUs' ||
      window.location.href === 'https://carstro-copy.web.app/marketing'
    ) {
